...
from app.core.multi_agent.coordinator import Agent
...
class MultiAgentTaskScheduler:
    ...
    async def add_task(self, task: Task):
        ...
        logger.info(
            f"Added task {task.task_id} with priority {task.priority.value}"
        )
    ...
    def _calculate_quality_score(
        ...
        priority_score = (
            high_priority_assigned / high_priority_total
    ...
    def get_stats(self) -> dict:
        ...
        return {
            **self.stats,
            ...
            "success_rate": (
                self.stats["completed_tasks"] / (self.stats["completed_tasks"] + self.stats["failed_tasks"])
